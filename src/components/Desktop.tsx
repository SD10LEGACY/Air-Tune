...
import AirPianoApp from './AirPianoApp';
import AirGuitar from './AirGuitar';
import AirDrums from './AirDrums';
import AirHarmonium from './AirHarmonium';
import AirXylophone from './AirXylophone';
...
import SoundRecorderApp from './SoundRecorderApp';
import ThemePropertiesApp from './ThemePropertiesApp';
